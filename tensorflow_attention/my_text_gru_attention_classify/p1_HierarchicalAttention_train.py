...
tf.app.flags.DEFINE_string("word_vocabulary_path",None,"word_vocabulary path")
tf.app.flags.DEFINE_string("label_vocabulary_path",None,"label_vocabulary path")
...
def data_preprocess(sample,sentences_length):
    ...
    partition_num=len(sentences_length)
    partition=[]
...
def build_inputs(self):
    ...
    samples, labels, sentences_length= inputs.batch_with_dynamic_pad(data,batch_size=self.config.batch_size,
...
def main(_):
    ...
    samples,labels,sentences_lengths = build_inputs()
